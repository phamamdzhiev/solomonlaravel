        ...
        <form action="{{route('app_formlazer_post')}}" method="post">
            ...
            <div>
              <div style="text-align: right">
                ...
                <div class=" justify-between align-center mb-2 mt-4" style="width: 300px; margin-left: auto">
                    ...
                    <input type="text" class="border rounded px-2 py-1 mb-4g" id="odbh" name="odbh" required>
                </div>
                <div class=" justify-between align-center" style="width: 300px; margin-left: auto">
                    ...
                    <input type="text" class="border rounded px-2 py-1 mb-4g" id="obshtina" name="obshtina" required>
                </div>
            </div>
            ...
            <div class=" align-center">
                <div>
                    ...
                    <input type="text" class="border rounded px-2 py-1 mb-4g" id="vet" name="vet" required>
                </div>
                <div>
                    <label class="font-semibold" for="vet-tel">Тел*</label>
                    <input type="text" class="border rounded px-2 py-1 mb-4g" name="vet-tel" required id="vet-tel">
                </div>
            </div>
            <hr class="my-6">
            <div class=" mb-6">
                <label class="font-semibold" for="no">№ на животновъдния обект*</label>
                <input type="text" class="border rounded px-2 py-1 mb-4g" name="no" required id="no">
                <label class="font-semibold" for="city">Населено място*</label>
                <input type="text" class="border rounded px-2 py-1 mb-4g" name="city" required id="city">
            </div>
            <div class=" mb-6">
                <label class="font-semibold" for="names">Три имена на собственика*</label>
                <input type="text" class="border rounded px-2 py-1 mb-4g" name="names" required id="names">
                <label class="font-semibold" for="egn">ЕГН*</label>
                <input type="text" class="border rounded px-2 py-1 mb-4g" name="egn" required id="egn">
            </div>
            <div class=" mb-6">
                <label class="font-semibold" for="ekont">Oфис на Еконт или адрес за доставка*</label>
                <textarea name="ekont" class="border rounded px-2 py-1 mb-4g w-full" id="ekont" cols="30" rows="2"
                          required></textarea>
            </div>
            <div class=" mb-6">
                <label class="font-semibold" for="mail">Имейл*</label>
                <input type="email" class="border rounded px-2 py-1 mb-4g" name="mail" id="mail">
                <label class="font-semibold" for="client_mobile">Телефон*</label>
                <input type="text" class="border rounded px-2 py-1 mb-4g" name="client_mobile" required id="client_mobile">
            </div>
            <div class=" mb-6">
                <label class="font-semibold" for="invoice">Данни за фактура*</label>
                <textarea name="invoice" class="border rounded px-2 py-1 mb-4g w-full" id="invoice" required cols="30"
                          rows="2"></textarea>
            </div>
            <div>
                <hr class="my-4">
            ...
            <div class="mt-10 flex">
                <input type="checkbox" id="deklariram"  name="confirm_policy" required>
